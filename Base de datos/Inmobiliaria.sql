...
--
-- Servidor: localhost
-- Tiempo de generación: 07-09-2025 a las 18:58:52
...
INSERT INTO `Contratos` (`IdContrato`, `IdInquilino`, `IdInmueble`, `Monto`, `FechaDesde`, `FechaHasta`, `Estado`, `CreadoPor`, `AnuladoPor`) VALUES
(1, 1, 1, 200000.00, '2025-09-10', '2026-02-11', 1, NULL, NULL),
(2, 2, 3, 150000.00, '2025-09-03', '2025-12-15', 1, NULL, NULL),
(3, 3, 4, 200000.00, '2025-09-01', '2025-11-10', 1, NULL, NULL),
(4, 4, 2, 100000.00, '2025-10-20', '2026-05-15', 1, NULL, NULL);
...
INSERT INTO `Inmuebles` (`IdInmueble`, `IdTipo`, `Uso`, `Ambientes`, `Direccion`, `Precio`, `Coordenadas`, `Estado`, `IdPropietario`) VALUES
(1, 2, 'residencial', 3, 'Av. Rivadavia 4521, Caballito, CABA', 120000.00, '-34.618921, -58.440385', 1, 1),
(2, 1, 'residencial', 2, 'San Martín 233, San Miguel de Tucumán', 100000.00, '-26.828544, -65.205899', 1, 2),
(3, 5, 'comercial', 10, 'Av. Pellegrini 1840, Rosario, Santa Fe', 205000.50, '-32.954812, -60.645937', 1, 4),
(4, 4, 'comercial', 3, 'Bv. San Juan 950, Córdoba Capital', 150000.00, '-31.417851, -64.187922', 1, 5),
(5, 3, 'comercial', 2, 'Calle Sarmiento 120, Mendoza', 300000.00, '-32.889732, -68.845907', 1, 5);
...
(5, 'Camila', 'Torres', '40234789', '11-3345-9876', 'camila.torres@example.com', 1);
